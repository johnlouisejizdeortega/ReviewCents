...
<nav class="sm:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur border-t border-gray-200 dark:border-gray-800 pb-[env(safe-area-inset-bottom)]">
    <div class="grid grid-cols-5">
        @foreach ($tabs as $tab)
            ...
            <a href="{{ route($tab['route']) }}" class="flex flex-col items-center justify-center gap-1 py-2 text-[11px] {{ $active ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400' }}">
        ...
        @auth
            ...
            <a href="{{ route('chat.index') }}" class="flex flex-col items-center justify-center gap-1 py-2 text-[11px] {{ $chatActive ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400' }}">
            ...
            <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center gap-1 py-2 text-[11px] {{ $accActive ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400' }}">
        ...
        @else
            <a href="{{ route('showcase.index') }}" class="flex flex-col items-center justify-center gap-1 py-2 text-[11px] {{ request()->routeIs('showcase.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400' }}">
