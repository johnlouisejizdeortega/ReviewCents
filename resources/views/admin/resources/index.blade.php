<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.resources.create') }}" class="px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700">+ New</a>
        </div>
            ...
            @forelse ($resources as $resource)
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin.resources.edit', $resource) }}" class="text-sm text-indigo-600 hover:underline">Edit</a>
