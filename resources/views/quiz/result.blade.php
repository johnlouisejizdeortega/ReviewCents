    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <x-card class="p-8 text-center">
            <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-full border-2 {{ $attempt->passed ? 'border-gray-900 dark:border-white' : 'border-gray-300 dark:border-gray-600' }}">
                <svg class="h-7 w-7 text-gray-900 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $attempt->passed ? 'M5 13l4 4L19 7' : 'M12 8v4m0 4h.01' }}" />
                </svg>
            </div>
